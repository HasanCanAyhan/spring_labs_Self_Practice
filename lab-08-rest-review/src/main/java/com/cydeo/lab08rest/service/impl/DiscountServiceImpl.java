...
public class DiscountServiceImpl implements DiscountService {
    ...
    public List<DiscountDTO> readAll() {
        ...
        return discountList.stream().map(discount -> mapperUtil.convert(discount,new DiscountDTO()))
    ...
    public DiscountDTO update(DiscountDTO discountDTO) {
        ...
        // we dont need to find id
        //normally, in discountdto should be unique field except id
        // since there is no unique field in DiscountDto, we can update direkt by using save method
