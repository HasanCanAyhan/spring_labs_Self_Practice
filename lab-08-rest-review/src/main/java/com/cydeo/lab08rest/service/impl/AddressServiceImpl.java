...
public class AddressServiceImpl implements AddressService {
    ...
    public List<AddressDTO> readAll() {
        ...
        return addressList.stream().map(address -> mapperUtil.convert(address,new AddressDTO()))
    ...
    public AddressDTO update(AddressDTO addressDTO) {
        ...
        address.setCustomer(mapperUtil.convert(customerService.findById(addressDTO.getCustomerId()),new Customer()));//safer way
    ...
    public List<AddressDTO> readAllByCustomerIdAndName(Long customerId, String name) {
        return addressRepository.findAllByCustomerIdAndName(customerId,name).stream()
                .map(address -> mapperUtil.convert(address,new AddressDTO()))
                .collect(Collectors.toList());
    }
}
