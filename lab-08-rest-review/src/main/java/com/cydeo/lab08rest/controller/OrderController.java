...
public class OrderController {
    ...
    public ResponseEntity<ResponseWrapper> retrieveOrderList(){
        ...
        return ResponseEntity.ok(new ResponseWrapper("Orders are successfully retrieved",orderService.retrieveOrderList(), HttpStatus.OK));
    ...
    public ResponseEntity<ResponseWrapper> getOrderListByPaymentMethod(@PathVariable PaymentMethod paymentMethod){
        ...
        return ResponseEntity.ok(new ResponseWrapper("Orders are successfully retrieved",orderService.getOrderListByPaymentMethod(paymentMethod), HttpStatus.OK));
    ...
    public ResponseEntity<ResponseWrapper> getOrderListByEmail(@PathVariable String email) throws Exception {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Orders are successfully retrieved",orderService.getOrderListByEmail(email), HttpStatus.OK));
    ...
    public ResponseEntity<ResponseWrapper> updateOrder(@RequestBody OrderDTO orderDTO){
        ...
        return ResponseEntity.ok(new ResponseWrapper("Orders are successfully updated",orderService.update(dto), HttpStatus.OK));
